...
#                                   input_shape=(self.state_size, 84, 84, 1)))
...
for episode in tqdm(range(episodes)):
    ...
    if log_every and episode and episode % log_every == 0:
        ...
        meanloss.append(avg_score)
        maxloss.append(max_score)
        minloss.append(min_score)



x = list(range(len(scores)))
plt.plot(x, scores, label = 'score') 
# plt.plot(x, maxloss, label = 'max loss') 
# plt.plot(x, minloss, label = 'min loss') 
# naming the x axis 
plt.xlabel('episode') 
# naming the y axis 
plt.ylabel('score') 
...
x = list(range(len(meanloss)))
plt.plot(x, meanloss, label = 'mean score') 
plt.plot(x, maxloss, label = 'max score') 
plt.plot(x, minloss, label = 'min score') 
# naming the x axis 
plt.xlabel('episode') 
# naming the y axis 
plt.ylabel('score') 
